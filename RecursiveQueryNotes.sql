...
(
    ...
    (
        SELECT TABELLA_DI_INIZIALIZZAZIONE.CHIAVE, NOME_TABELLA.SUP_FOO --IN QUESTO ORDINE, CI DEVE ESSERE CORRISPONDENZA CON LE COLONNE DI NOME_TABELLA
...
VA SEMPRE CREATA UNA NUOVA TABELLA SU CUI LAVORARE ANCHE SE RISULTA ESSERE LA COPIA DI UNA TABELLA GIA PRESENTE */